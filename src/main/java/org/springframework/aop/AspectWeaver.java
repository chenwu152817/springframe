...
import org.springframework.aop.annotation.Order;
import org.springframework.aop.aspect.AspectInfo;
import org.springframework.aop.aspect.DefaultAspect;
...
public class AspectWeaver {
    ...
    private List<AspectInfo> collectRoughMatchedAspectListForSpecificClass(List<AspectInfo> aspectInfoList, Class<?> targetClass) {
        List<AspectInfo> roughMatchedAspectList = new ArrayList<AspectInfo>();
    ...
    private List<AspectInfo> packAspectInfoList(Set<Class<?>> aspectSet) {
        List<AspectInfo> aspectInfoList = new ArrayList<AspectInfo>();
